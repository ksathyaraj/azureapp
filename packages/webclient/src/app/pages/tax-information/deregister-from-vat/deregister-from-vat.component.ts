...
@Component({
  selector: "web-deregister-from-vat",
  templateUrl: "./deregister-from-vat.component.html",
})
export class DeregisterFromVatComponent implements OnInit {
  vatNumber = "";
  savesuccessmessage = "";
  modalHeading = "";
  modalContent = "";
  ...
  getTranslation() {
    ...
    this.translateService
      .get("resources.settings-companyprofile-deregisterforvat-info-content")
      .subscribe((res: string) => {
