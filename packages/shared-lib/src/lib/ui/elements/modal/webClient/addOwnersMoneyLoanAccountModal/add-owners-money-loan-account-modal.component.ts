...
@Component({
    ...
    templateUrl: "./add-owners-money-loan-account-modal.component.html",
    styleUrls: ["./add-owners-money-loan-account-modal.component.css"],
})

export class AddOwnersMoneyLoanAccountModalComponent {
    ...
    passBack(frm: any) {
        ...
        if (!frm.invalid) {
            this.dataService.post(webApi.addLoanAccount, { LoanAccountName: this.loanAccountName, LoanAccountId: this.params.loanAccountId, customLedgerAccountId: this.params.customLedgerAccountId }).subscribe(() => {
